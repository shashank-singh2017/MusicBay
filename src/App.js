  ...
  <div className="row" style={{marginLeft: "6%", marginTop: 15}}>
              <div className="col-sm-10">
                ...
                {this.state.tracks.map((track) => {
                  return (
                  <div className="row" style={{marginTop: 20, backgroundColor: "#391285", color: "white",height: "auto", paddingBottom: 10}}>
                    <div className="col-sm-10">
                        ...
                        <div className="col-sm-10" style={{float: "right", marginRight: "5%"}}>
                          ...
                          <div className="col-sm-5" style={{paddingLeft: "3%", paddingTop: 8, color: "white"}}>
